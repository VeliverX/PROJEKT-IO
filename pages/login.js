...
export default function Home() {
  return (
    ...
    <div className="max-w-md w-full bg-white rounded p-10  space-y-6">
        ...
        <a className="flex justify-center text-sm text-gray-500 hover:underline pb-4" href="#">Zaloguj jako pracownik</a>
        </Link>
        <Link href="rejestracja">
        <a className="flex justify-center text-sm text-gray-500 hover:underline" href="#">Załóż konto</a>
        </Link>
        </div>  
