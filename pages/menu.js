  ...
  <div className="w-full bg-gray-800">
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div className="text-center pb-12">
            <h2 className="text-lg font-extrabold text-indigo-600">MENU</h2>
            <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-white">Sprawdź nasze produkty!</h1>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                    <img className="object-center object-cover rounded-full h-36 w-36" src="kebab.png" alt="produkt"></img>
                </div>
                <div className="text-center">
                    <p className="text-xl text-white font-bold mb-2">Kebab</p>
                    <p className="text-base text-yellow-300 font-normal">16zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white" >Baranina, Sałatka, Sos, Bułka</p>
                </div>
            </div>
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                ...
                <div className="text-center">
                    <p className="text-xl text-white font-bold mb-2">Rollo</p>
                    <p className="text-base text-yellow-300 font-normal">20zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white" >Baranina, Sałatka, Sos, Pita</p>
                </div>
            </div>
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                ...
                <div className="text-center">
                    <p className="text-xl text-white font-bold mb-2">Kubełek</p>
                    <p className="text-base text-yellow-300 font-normal">25zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white" >Frytki, Sałatka, Sos, Baranina, W Kubełeku</p>
                </div>
            </div>
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                ...
                <div className="text-center">
                    <p className="text-xl text-white font-bold mb-2">Rollo Amerykańskie</p>
                    <p className="text-base text-yellow-300 font-normal">17zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white" >Baranina, Frytki, Sos, Pita</p>
                </div>
            </div>
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                ...
                <div className="text-center">
                    <p className="text-xl text-white font-bold mb-2">Frytki</p>
                    <p className="text-base text-yellow-300 font-normal">6zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white" >Fytki z głębokiego oleju</p>
                </div>
            </div>
            <div className="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                ...
                <div className="text-center ">
                    <p className="text-xl text-white font-bold mb-2">Sałatka Kebab</p>
                    <p className="text-base text-yellow-300 font-normal">21zł</p>
                    <p className="text-base text-indigo-600 font-normal hover:text-white " >Kurczak, Sałatka, oliwa, sos majonezowy</p>
                </div>
            </div>
        </div>
    </section>
