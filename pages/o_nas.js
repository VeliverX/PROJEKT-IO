  ...
  <div className="w-full bg-gray-800">
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div className="text-center pb-12">
            <h2 className="text-5xl font-bold text-indigo-200">Naszą wizją jest dać każdemu łatwy oraz szybki dostęp do ulubionych produktów!</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
            <div className="w-full bg-gray-600 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                    <img className="object-center object-cover rounded h-52" src="about.png" alt="produkt"></img>
                </div>
                <div className="text-center">
                    <h1 className="text-xl text-white font-bold mb-2">Jesteśmy Döner Kebab</h1>
                    <p className="text-base text-gray-300 font-normal">Portal, który pozwala zamawiać nalepsze posiłki z całej okolicy w zaledwie kilka minut.
                    Naszymi najważniejszymi zasadami są:
                    <ul>
                    <li className="text-base text-gray-100 font-bold">&#9830; szybki oraz łatwy sposób zamawiania,</li>
                    <li className="text-base text-gray-100 font-bold">&#9830; wybierać tylko najlepsze lokalne pordukty,</li>
                    <li className="text-base text-gray-100 font-bold">&#9830; stały kontakt z odbiorcami by stale się rozwijać.</li>
                    </ul>
            ...
            <div className="w-full bg-gray-600 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                    <img className="object-center object-cover  h-52" src="user.png" alt="produkt"></img>
                    <span className="text-base text-gray-300 font-normal">Ponad 20 000 użytkowników.</span>
                </div>
                <div className="mb-8">
                    <img className="object-center object-cover  h-52" src="city.png" alt="produkt"></img>
                    <span className="text-base text-gray-300 font-normal">Działamy w 11 polskich miastach.</span>
                </div>
