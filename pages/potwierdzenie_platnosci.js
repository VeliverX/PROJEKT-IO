...
<div className="bg-white h-96 w-96">
      <div className="bg-white p-6  md:mx-auto">
        ...
        <div className="text-center">
            <h3 className="md:text-2xl text-base text-gray-900 font-semibold text-center">Płatność zakończona!</h3>
            <p className="text-gray-600 my-2">Dziękujemy za dokonanie płatności online.</p>
            <p> Miłego dnia!  </p>
