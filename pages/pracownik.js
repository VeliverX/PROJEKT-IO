...
<section className="flex justify-center items-center h-screen bg-yellow-400">
    <div className="max-w-md w-full bg-white rounded p-10  space-y-6">
        ...
        <div>
            <p className="text-gray-600 text-xl font-medium">Dołącz CV</p>
            <input  type="file" id="CvId" name="cv"></input>
        </div>
        <div>
        ...
        <div className="flex items-center justify-between">
            <div className="flex flex-row items-center">
                ...
                <label htmlFor="comments" className="ml-2 text-sm font-light text-gray-600">Zgadzam się na wykorzystywanie moich danych w przyszłych rekrutacjach i przechowywanie ich przez okres 12 miesięcy.</label>
            </div>
        </div>
        <div>
            <Link href="./">
